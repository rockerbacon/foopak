...
oneTimeSetUp() {
	...
	cd $environment_dir
	./foopak add rockerbacon/foopak-mock-module
}
...
test_should_correctly_link_files_in_module_root() {
	expected_link="$environment_dir/foopak_modules/rockerbacon_foopak-mock-module/script-1"
...
test_should_correctly_link_nested_files_to_project_root() {
	expected_link="$environment_dir/foopak_modules/rockerbacon_foopak-mock-module/depth1/depth2/nested-script"
